...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../T05_M2_XADCTest/T05_M2_XADCTest.gen/sources_1/ip/clk_wiz_0" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.T05_M2_TopLevel xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.T05_M2_TopLevel -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log T05_M2_TopLevel_sc.so .tmp_log xcelium_lib waves.shm c.obj)
