...
#
# Script generated by Vivado on Mon Dec 16 00:14:27 +0000 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : T05_M3_TopLevel.sh
...
#
# Usage        : T05_M3_TopLevel.sh
#                T05_M3_TopLevel.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                T05_M3_TopLevel.sh [-reset_run]
#                T05_M3_TopLevel.sh [-reset_log]
#                T05_M3_TopLevel.sh [-help]
#
...
#                script (type 'T05_M3_TopLevel.sh -help' for more information).
#
...
# script info
echo -e "T05_M3_TopLevel.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./T05_M3_TopLevel.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../T05_M3_Project_VFinal.gen/sources_1/ip/clk_wiz_0" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.T05_M3_TopLevel xil_defaultlib.glbl -o T05_M3_TopLevel_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./T05_M3_TopLevel_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key T05_M3_TopLevel_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc T05_M3_TopLevel_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./T05_M3_TopLevel.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: T05_M3_TopLevel.sh [-help]\n\
Usage: T05_M3_TopLevel.sh [-step]\n\
Usage: T05_M3_TopLevel.sh [-lib_map_path]\n\
Usage: T05_M3_TopLevel.sh [-reset_run]\n\
Usage: T05_M3_TopLevel.sh [-reset_log]\n\
Usage: T05_M3_TopLevel.sh [-keep_index]\n\
Usage: T05_M3_TopLevel.sh [-noclean_files]\n\n\
