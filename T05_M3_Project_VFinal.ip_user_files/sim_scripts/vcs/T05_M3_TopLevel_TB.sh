...
#                script (type 'T05_M3_TopLevel_TB.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.T05_M3_TopLevel_TB xil_defaultlib.glbl -o T05_M3_TopLevel_TB_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./T05_M3_TopLevel_TB_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key T05_M3_TopLevel_TB_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc T05_M3_TopLevel_TB_simv.daidir vcs_lib c.obj)
