...
#
# Script generated by Vivado on Fri Jan 10 22:09:14 +0000 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : T05_M3_TopLevel_TB.sh
...
#
# Usage        : T05_M3_TopLevel_TB.sh
#                T05_M3_TopLevel_TB.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                T05_M3_TopLevel_TB.sh [-reset_run]
#                T05_M3_TopLevel_TB.sh [-reset_log]
#                T05_M3_TopLevel_TB.sh [-help]
#
...
# script info
echo -e "T05_M3_TopLevel_TB.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./T05_M3_TopLevel_TB.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xpm -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot T05_M3_TopLevel_TB xil_defaultlib.T05_M3_TopLevel_TB xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim T05_M3_TopLevel_TB -key {Behavioral:sim_1:Functional:T05_M3_TopLevel_TB} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb T05_M3_TopLevel_TB.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./T05_M3_TopLevel_TB.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: T05_M3_TopLevel_TB.sh [-help]\n\
Usage: T05_M3_TopLevel_TB.sh [-step]\n\
Usage: T05_M3_TopLevel_TB.sh [-lib_map_path]\n\
Usage: T05_M3_TopLevel_TB.sh [-reset_run]\n\
Usage: T05_M3_TopLevel_TB.sh [-reset_log]\n\
Usage: T05_M3_TopLevel_TB.sh [-keep_index]\n\
Usage: T05_M3_TopLevel_TB.sh [-noclean_files]\n\n\
